...
Generates SHA-256 hash of the given C<$msg>.
...
the computation state of the SHA-256 algorithm.
...
Generates SHA-512 hash of the given C<$msg>.
...
the computation state of the SHA-512 algorithm.
