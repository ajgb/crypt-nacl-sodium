...
Un-ecrypted messages and their MACs can be made public, while the key should
remain secret.
...
Single pass and streaming API keyed message authentication using HMAC-SHA256,
HMAC-SHA512 and HMAC-SHA512/256 are described below.
...
the computation state of the HMAC-SHA-256 algorithm.
...
the computation state of the HMAC-SHA-512 algorithm.
...
the computation state of the HMAC-SHA-512/256 algorithm.
